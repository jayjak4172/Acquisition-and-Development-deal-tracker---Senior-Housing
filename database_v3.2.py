...
class DealDatabase:
    ...
    def _initialize_database(self):
        ...
        print(f"✓ Database v3.2 ready: {self.db_path}")
    ...
    def insert_deal(self, deal_data):
        ...
        try:
            self.cursor.execute('''
                INSERT INTO deals (
                    deal_type, property_name, region, seller, buyer, broker,
        ...
        try:
            self.cursor.execute('''
                INSERT INTO development_projects (
                    ...
                    operator, operator_type, region, building_type,
